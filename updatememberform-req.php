...
<form role="form" action="index.php" method="POST">
    <?php 
            ...
            $qry = "update users set fullname='$fullname', email='$email', dob='$dob', gender='$gender', service='$service', amount='$totalamount', plans='$plans', address='$address', phoneno='$phoneno' where email='$email'";
