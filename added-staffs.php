...
<div id="content">
  ...
  <form role="form" action="index.php" method="POST">
            ...
            $password = md5($password);
                    ...
                    $qry = "insert into trainer(fullname,username,password,email,address,designation,gender,contact) values ('$fullname','$username','$password','$email','$address','$designation','$gender','$contact')";
